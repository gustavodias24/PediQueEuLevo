...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.raw.produtonotfound).into(mainBinding.imageView3);
    }
    ...
    private void ListenerProdutos() {
        ...
        refProdutos.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if ( produtos.isEmpty()){
                    mainBinding.imageView3.setVisibility(View.VISIBLE);
                }else{
                    mainBinding.imageView3.setVisibility(View.GONE);
                }
            }
    ...
    private void configurarrRecyclerProdutos(){
        ...
        adapterProduto = new AdapterProduto(produtos, this, true, false, dialogCarregando);
